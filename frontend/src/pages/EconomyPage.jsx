  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <a
          href={`https://wa.me/?text=${encodeURIComponent('Mirá los compromisos económicos de Boca Juniors: ' + window.location.href)}`}
          target="_blank"
        ...
        <a
          href={`https://x.com/intent/tweet?text=${encodeURIComponent('Mirá los compromisos económicos de Boca Juniors: ' + window.location.href)}`}
          target="_blank"
          rel="noopener noreferrer"
